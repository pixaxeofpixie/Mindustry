...
public class Items implements ContentList{
    public static Item scrap, copper, lead, graphite, coal, titanium, thorium, silicon, plastanium, phaseFabric, surgeAlloy, steel,
    ...
    public void load(){
        ...
        steel = new Item("steel", Color.valueOf("9d8aad")){{
            cost = 1.8f;
        }};
